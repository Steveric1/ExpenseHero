...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-28o+p1yr70*qkks35*w8&9umnnm2j+ufwou45pg74(%oxxj-w*')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ["127.0.0.1", "localhost", "expensehero.onrender.com"]
...
# Email settings for production and developement
if os.environ.get('DJANGO_ENV') == 'production':
    SITE_DOMAIN = 'expensehero.onrender.com'
